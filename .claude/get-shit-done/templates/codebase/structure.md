...
- Usage: Reference from command with `@/home/brian/personal/claude-code-bundles/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/brian/personal/claude-code-bundles/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/brian/personal/claude-code-bundles/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
