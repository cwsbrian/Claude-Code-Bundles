...
Use template from `/home/brian/personal/claude-code-bundles/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/brian/personal/claude-code-bundles/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/brian/personal/claude-code-bundles/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
