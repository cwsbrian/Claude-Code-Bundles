...
- **Global scope**: `/home/brian/personal/claude-code-bundles/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/brian/personal/claude-code-bundles/.claude/notes/`)
...
2. Glob `/home/brian/personal/claude-code-bundles/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/brian/personal/claude-code-bundles/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/brian/personal/claude-code-bundles/.claude/notes/` — works in any directory
