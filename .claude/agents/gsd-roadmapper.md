...
Reference full template: `/home/brian/personal/claude-code-bundles/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/brian/personal/claude-code-bundles/.claude/get-shit-done/templates/state.md`.
